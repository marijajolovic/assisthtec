...
OUTPUT_DIR="starcoder-llm-7b-base" # output_dir
BF16=True                        # bf16
FP16=False                       # no_fp16
...
training_args = TrainingArguments(
    output_dir=f"marijajolovic/{OUTPUT_DIR}",
...
client = WebClient(token='xoxb-8551221055013-8577143770480-iuvZPEhdvrcGjO83zE5nzmLg')
# Send a message to yourself using your username
try:
    response = client.chat_postMessage(
        channel='@46-2021',  # Replace with your Slack username
