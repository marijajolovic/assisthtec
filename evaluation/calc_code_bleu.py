...
# print(onlyfiles)
keywords = [x.strip() for x in open('/home/mjolovic/CodeXGLUE/Code-Code/code-to-code-trans/evaluator/CodeBLEU/keywords/'+args.lang+'.txt', 'r', encoding='utf-8').readlines()]
